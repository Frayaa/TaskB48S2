...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create remix-e994
  fly apps create remix-e994-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app remix-e994
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app remix-e994-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'remix-e994-staging' does not match app name in config file 'remix-e994'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name remix-e994-db
  fly postgres attach --app remix-e994 remix-e994-db

  fly postgres create --name remix-e994-staging-db
  fly postgres attach --app remix-e994-staging remix-e994-staging-db
  ```
